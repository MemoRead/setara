...
@section('container')
    ...
    <div class="card col-lg-8">
        <div class="card-body">
            <h5 class="card-title">Form To Edit Job Title</h5>

            <!-- Floating Labels Form -->
            <form class="row g-3" method="post" action="/dashboard/jobs/{{ $job->id }}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                            id="floatingJobtitle" placeholder="title of Jobs" name="title"
                ...
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('job_details') is-invalid @enderror"
                            ...
                            value="{{ old('job_details', $job->job_details) }}">
